...
import 'package:toolbox/classes/providers/desktop_navigation.dart'; // 状态管理器
import 'package:toolbox/ui/desktop/page/login.dart'; // 导入登录页面
import 'package:toolbox/ui/desktop/page/oms.dart'; // 导入OMS页面
...
Future<void> main() async {
  ...
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => DesktopNavigation()),
      ],
      child: const MyApp(),
    ),
  );
